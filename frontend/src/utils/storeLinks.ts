...
// TODO: replace once piercer.ai has a real App Store Connect / Google Play
// Console listing - these placeholders keep "Rate on App Store" wired to
// real navigation logic now, without pretending a listing exists.
